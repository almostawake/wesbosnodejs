...
exports.createStore = async (req, res) => {
    req.body.author = req.user._id; // link this store to current user
...
exports.getStores = async (req, res) => {
    ...
    if(!stores.length && skip) {
        req.flash('info',`No such page, you're on the last existing page`);
...
exports.storesNear = async (req, res) => {
